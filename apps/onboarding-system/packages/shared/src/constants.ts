...
export const REQUEST_STATUSES = ['draft', 'submitted', 'manager_review', 'it_review', 'hr_fill', 'hr_searching', 'manager_start_date', 'it_close', 'approved', 'denied', 'in_progress', 'waiting', 'completed', 'cancelled'] as const;
...
export const STATUS_LABELS: Record<string, string> = {
  ...
  manager_start_date: 'Manager — Start Date',
  it_close: 'Needs IT Close',
  approved: 'Approved',
  denied: 'Denied',
...
export const KANBAN_COLUMNS: { key: string; label: string; statuses: RequestStatus[]; color: string }[] = [
  { key: 'open',        label: 'Open',         statuses: ['submitted', 'manager_review', 'it_review', 'hr_fill', 'hr_searching', 'manager_start_date', 'it_close', 'approved'], color: '#3b82f6' },
